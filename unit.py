...
# Used in `ccdiagram_workflow.configurational_coordinate` for phonon-energy evaluation.
BOHR2ANG = const.physical_constants["Bohr radius"][0] / 1e-10

# Energy conversion: 1 Hartree = 27.211386... eV.
# Used in `ccdiagram_workflow.configurational_coordinate` for curvature-to-energy conversion.
HARTREE2EV = const.physical_constants["Hartree energy in eV"][0]

# Mass conversion: 1 amu = 1822.888... electron masses.
# Used in `ccdiagram_workflow.configurational_coordinate` for modal-mass normalization.
